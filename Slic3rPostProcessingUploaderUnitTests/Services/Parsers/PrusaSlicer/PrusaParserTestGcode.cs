...
{
    /// <summary>
    /// 20mm calibration cubes sliced headlessly with PrusaSlicer 2.9.2 and 3.0.0-alpha11, with the toolpaths removed.
    /// Neither file carries thumbnails, since the CLI export does not render them.
    /// </summary>
    internal class PrusaParserTestGcode
    {
        /// <summary>
        /// PrusaSlicer 2.9.2, Anycubic Kobra 2 Neo user profile. Filament density is 0, so weight has to be estimated from length.
        /// </summary>
        public static string Cube_PrusaSlicer2 = """
        ...
        /// <summary>
        /// PrusaSlicer 3.0.0-alpha11, Prusa MINI 0.4 / 0.20mm SPEED / Prusament PLA. Carries the new prusaslicer_json_config block and the enum-valued support_material.
        /// </summary>
        public static string Cube_PrusaSlicer3 = """
